...
DECL_FUNCTION(void, __thiscall, ParameterBlockOpenFile, ParameterBlock_OpenFile_Address, void*, char*, int, int, size_t*, size_t);
...
public:
	...
	int GetParameter(char* ptr, int default_val, int* res) {
		return ParameterBlockGetParameterDefaultInt(reserved, ptr, default_val, res);
	}
	int GetParameter(const char* ptr, int default_val, int* res) {
