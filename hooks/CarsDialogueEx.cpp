...
void CarsDialogueEx::Install() {
	...
	WritePUSH(AsVoidPtr(0x004f32c8), AsVoidPtr(0xA40 + 0x1BE4)); // patch class size
	...
	Logging::Log("[CarsDialogueEX::Install] Succesfully moved CarsCharacterDialogue array!\n");

	auto lpCarsDialogue = *(DWORD*)(*(DWORD*)(0x00718A74 + 1088) + 68); // lpCarsGame->lpCarsAudioManager->lpCarsDialogue
}
